...
Ro_1 = Constant(10**4) # denominator for Coriolis term
Ro_2 = Constant(10**3) # denominator for grad theta
...
# f.assign(0) 
f.assign(i_vel)
q.assign(0) # since velocity is zero
