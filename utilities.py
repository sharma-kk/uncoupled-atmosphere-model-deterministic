...
def comp_solve_for_v_given_q(q):
    """ using compatible FE spaces, given vorticity, solve for corresp. vel. Vel obtained needs to be projected using project(v,fucntion_space)"""
    msh = q.function_space().mesh()
    Vcg = FunctionSpace(msh, "CG", 2)
